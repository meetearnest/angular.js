/**
 * @license AngularJS v1.3.15-local+sha.da079d2
...
function minErr(module, ErrorConstructor) {
  ...
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.15-local+sha.da079d2/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.15-local+sha.da079d2',    // all of these placeholder strings will be replaced by grunt's
